...
PICS = (environ.get('PICS', 'https://te.legra.ph/Anya-02-09-2070 https://te.legra.ph/Anya-2-02-09 https://te.legra.ph/Anya-3-02-09 https://te.legra.ph/Anya-4-02-09 https://te.legra.ph/Anya-5-02-09')).split()
NOR_IMG = environ.get("NOR_IMG", "https://te.legra.ph/Anya-2-02-09")
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/b60d2facc538ad82ad22d.jpg")
NEWGRP = environ.get("NEWGRP", "https://te.legra.ph/Anya-3-02-09")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1702061654').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001621828922').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "AnyaxBot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/BqRequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/BinaryQuest')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'BqChats')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', 0))
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 't.me/Sahil_x_official')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "[{file_name}](https://t.me/Binaryquest)\n\n<b>•────•────────•────•\n📌 ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ​ : [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/BqRequest)\n🎬 ᴍᴏᴠɪᴇs ᴄʜᴀɴɴᴇʟ​ : [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/BinaryQuest/13)\n•────•────────•────•\n\n©️ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : [CO HERE](https://t.me/Itz_Sahil_Official)</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>{mention}'s Qᴜᴇʀʏ ☞ <code>{query}</code>\n\n<b>🏷 Tɪᴛʟᴇ</b> : <a href={url}>{title}</a>\n\n🌟 Rᴀᴛɪɴɢ : <a href={url}/ratings>{rating}</a> / 10\n💀 Rᴇʟᴇᴀsᴇ :  <b>{release_date}</b> <b>{countries}</b>\n\n🎭 Gᴇɴʀᴇs : <b>#{genres}</b></b>\n\n<b>🔅 Pᴏᴡᴇʀᴇᴅ Bʏ : {message.chat.title}</b> \n<b>JOIN : @BinaryQuest</b>")
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'd7d0c19d31d63f07682873d56863c55c61cfdffa')
